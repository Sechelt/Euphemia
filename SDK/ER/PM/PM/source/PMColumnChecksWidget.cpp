...
PMColumnChecksWidget::PMColumnChecksWidget( PMColumn *pColumn, QWidget *pwidgetParent )
    : QWidget( pwidgetParent )
{
    ...
    plineeditDefault->setText( pColumn->getDefault() );                                                                                 
    ...
    plineeditMinimum->setText( pColumn->getMinimum() );                                                                                 
    ...
    plineeditMaximum->setText( pColumn->getMaximum() );                                                                                 
    ...
    plineeditFormat->setText( pColumn->getFormat() );                                                                                   
    ...
    plineeditUnit->setText( pColumn->getUnit() );                                                                                       
...
PMColumnChecksWidget::~PMColumnChecksWidget()
{
/*
    QSettings settings;                                                                                                      
