...
AWObjectUsesWidget::AWObjectUsesWidget( AWObject *pObject, QWidget *pwidgetParent )
    : QWidget( pwidgetParent )
{
    ...
    QTableWidget *pTable = new QTableWidget( pObject->getUsesCount(), 4, this );
...
//    pTable->setSelectionMode( QAbstractItemView::NoSelection );    
    ...
    int nRow = 0;
    QList<ADObjectReferenceKey> listKeys = pObject->getUsesKeys();
