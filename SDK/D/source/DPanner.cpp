...
DPanner::DPanner( DGraphicsSceneProxy *pScene, QWidget *pParent )
...
void DPanner::slotUpdate() 
{ 
   viewport()->update();
}

void DPanner::resizeEvent( QResizeEvent *pEvent )
{
    Q_UNUSED(pEvent);
...
void DPanner::mousePressEvent( QMouseEvent *pEvent )
{
 ...
 * \param pEvent 
 */
void DPanner::mouseMoveEvent( QMouseEvent *pEvent )
{
    if ( !bPanning ) return;
...
void DPanner::mouseReleaseEvent( QMouseEvent *pEvent )
{
    Q_UNUSED(pEvent);
    bPanning = false;
    setCursor( Qt::OpenHandCursor );
 ...
 * \param rect 
 */
void DPanner::drawForeground( QPainter *pPainter, const QRectF &rect )
{
    Q_UNUSED(rect);
 ...
 * \param rect 
 */
void DPanner::drawBackground( QPainter *pPainter, const QRectF &rect )
{
    Q_UNUSED(rect);
