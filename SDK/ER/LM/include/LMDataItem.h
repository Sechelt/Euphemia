...
*/
class LMDataItem : public AWObject, public LMObject
{
    Q_OBJECT
public:
    LMDataItem( LMModel *pmodel );
    virtual ~LMDataItem();

    // SETTERS
//    virtual void setName( const QString &s );
    virtual void setDomain( LMDomain *pdomain );      
    ...
    virtual QString             getFriendlyClassName()          { return tr( "Data Item" );         }
    ...
    virtual void doUsesAdd( ADObject *pmodel );
    virtual void doUsesRemove( ADObject *pmodel );
