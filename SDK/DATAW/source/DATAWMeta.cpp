 ...
 * 
 * ODBC does not provide for this excplicitly...
 * 
...
//    if ( stringDBMS_NAME == "MariaDB" ) return isAGMariaDB( stringTable, stringColumn );
//    if ( stringDBMS_NAME == "MySQL" ) return isAGMySQL( stringTable, stringColumn );
 ...
 * \return bool 
 */
bool DATAWMetaTable::isAGMariaDB( const QString &stringTable, const QString &stringColumn )
{
    return isAGMySQL( stringTable, stringColumn );
}
 ...
 * \return bool 
 */
bool DATAWMetaTable::isAGMySQL( const QString &stringTable, const QString &stringColumn )
{
    Q_UNUSED( stringTable );
    Q_UNUSED( stringColumn );
