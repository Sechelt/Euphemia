...
// SColorsMatrix
//
SColorsMatrix::SColorsMatrix( QWidget *pParent )
    : QWidget( pParent )
{
...
void SColorsMatrix::slotRefresh()
{
    vectorColors = g_SColors->getColors();
    update();
}
 ...
 * \param pEvent 
 */
void SColorsMatrix::mousePressEvent( QMouseEvent *pEvent )
{
 ...
 * \param pEvent 
 */
void SColorsMatrix::mouseDoubleClickEvent( QMouseEvent *pEvent )
{
    if ( pEvent->button() != Qt::LeftButton )
    {
    ...
    QColor colorNew = SColorsPickerDialog::getColor( &bOk, color, this );
    if ( bOk )
    {
...
void SColorsMatrix::paintEvent( QPaintEvent *pEvent )
{
    Q_UNUSED(pEvent);
...
int SColorsMatrix::getIndex( const QPoint &point )
{
...
// SColorsWidget
//
SColorsWidget::SColorsWidget( QWidget *pParent )
    : QWidget( pParent )
{
    ...
    // palette
    {
        SColorsMatrix *p = new SColorsMatrix( this );
...
void SColorsWidget::slotRefresh( const QColor & )
{
}

void SColorsWidget::slotRefresh()
{
