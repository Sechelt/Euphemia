...
LMDataItemChecksWidget::LMDataItemChecksWidget( LMDataItem *pDataItem, QWidget *pwidgetParent )
: QWidget( pwidgetParent )
{
    ...
    plineeditDefault->setText( pDataItem->getDefault() );                                                                                 
    ...
    plineeditMinimum->setText( pDataItem->getMinimum() );                                                                                 
    ...
    plineeditMaximum->setText( pDataItem->getMaximum() );                                                                                 
    ...
    plineeditFormat->setText( pDataItem->getFormat() );                                                                                   
    ...
    plineeditUnit->setText( pDataItem->getUnit() );                                                                                       
...
LMDataItemChecksWidget::~LMDataItemChecksWidget()
{
/*
    QSettings settings;                                                                                                      
