...
SQL92ModelPalWidget::SQL92ModelPalWidget( SQL92ModelEditorWidget *pEditor, QWidget *pParent )
    : AWPalWidget( pEditor, pParent )
{
    ...
    // shapes
    {
        ...
        pToolBox->addItem( pWidgetTools, tr( "ERD: Physical Model\nSQL92" ) );
    }
...
SQL92ModelPalWidget::~SQL92ModelPalWidget()
{
#ifdef DEBUG_DESTRUCTORS
