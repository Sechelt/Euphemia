...
LMAdditionalChecksWidget::LMAdditionalChecksWidget( QWidget *pParent, const QString &stringClient, const QString &stringServer )
    : QWidget( pParent )
{
...
void LMAdditionalChecksWidget::slotClient()
{
    emit signalClient( pClient->toPlainText() );
}

void LMAdditionalChecksWidget::slotServer()
{
